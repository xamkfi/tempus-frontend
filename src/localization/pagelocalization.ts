...
const resources = {
  en: {
    translation: {
      ...
      "info3Below": "The calculator is located further down the page.",
      "goToCalculator": "Go to calculator",
      "solarBatteryTitle": "Solar power system and energy storage optimization tool",
      "solarBatteryDescription": "With the tool at the link below, you can use your own consumption data to assess the economic viability of a solar power system and connected energy storage. The tool also helps you plan for longer power outages.",
      "solarBatteryProjectCredit": "The tool was developed as part of the EU co-funded project Smart Grid and Industrial Energy Community Pilot Platform in Kotka Mussalo, coordinated by the Regional Council of Kymenlaakso.",
      "solarBatteryEuFunding": "Co-funded by the European Union",
      "solarBatteryLinkLabel": "Open optimization tool",
  ...
  "chart":{
    "x": "time",
    "y": "cent/kWh",
    "chartTitle15minute": "Prices at 15 minute intervals",
    ...
    translation: {
      ...
      "info3Below": "Laskuri löytyy alempaa sivulta.",
      "goToCalculator": "Siirry laskuriin",
      "solarBatteryTitle": "Aurinkosähköjärjestelmän ja energiavaraston optimointityökalu",
      "solarBatteryDescription": "Alla olevan linkin työkalulla voit oman kulutusdatasi perusteella tarkastella aurinkosähköjärjestelmän ja siihen kytketyn energiavaraston taloudellista kannattavuutta. Työkalun avulla voit myös suunnitella omaa varautumistasi pidempiin sähkökatkoihin.",
      "solarBatteryProjectCredit": "Työkalu on tehty osana EU:n osarahoittamaa hanketta Älykkään sähköverkon ja teollisen energiayhteisön kokeilualusta Kotkan Mussalossa, koordinaattorina Kymenlaakson Liitto.",
      "solarBatteryEuFunding": "Euroopan unionin osarahoittama",
      "solarBatteryLinkLabel": "Avaa optimointityökalu",
  ...
  "chart":{
    ...
    "y": "snt/kWh",
    "label": "snt/kWh",
    "chartTitle15minute": "15 minuutin hinnat",
